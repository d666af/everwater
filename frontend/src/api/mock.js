...
export const MOCK_PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Природная горная вода',
  ...
  },
  {
    ...
    description: 'Идеально для дома и офиса',
  ...
  },
  {
    ...
    description: 'Большой объём для семьи',
  ...
  },
  {
    ...
    description: 'Выгодный формат для дома',
  ...
  },
  {
    ...
    description: 'Стандартный кулерный бутыль',
    photo_url: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&q=80',
    is_active: true, sort_order: 6, type: 'still',
  },
  {
    id: 7, name: 'Вода 0.5л газированная', volume: 0.5, price: 3000,
    description: 'Природная газированная вода',
  ...
  {
    id: 8, name: 'Вода 1л газированная', volume: 1, price: 5000,
    description: 'С натуральной газацией',
  ...
  {
    id: 9, name: 'Вода 1.5л газированная', volume: 1.5, price: 6000,
    description: 'Освежающая газированная',
  ...
  {
    id: 10, name: 'Вода 5л газированная', volume: 5, price: 10000,
    description: 'Большой объём с газом',
